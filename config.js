...
STICKER_NAME: process.env.STICKER_NAME || "vos bangala",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "24175829369",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "*𝕮𝖑𝖊𝖗𝖛𝖞 𝖇𝖔𝖙*",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝕮𝖑𝖊𝖗𝖛𝖞 𝖇𝖔𝖙 🙌🏾*",
// add bot owner name    
